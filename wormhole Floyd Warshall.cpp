...
Is this code correct if question says that if spaceship lands on wormhole then it is compulsory tot ravel through wormhole?
...
        // Wormhole is bi-directional: u to v and v to u cost 'cost'
        dist_matrix[u][v] = (long long)cost;
        dist_matrix[v][u] = (long long)cost;
    }
